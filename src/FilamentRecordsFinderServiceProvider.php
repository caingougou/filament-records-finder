...
namespace Caingougou\FilamentRecordsFinder;
...
use Caingougou\FilamentRecordsFinder\Livewire\RecordsModalContent;
    ...
    public function configurePackage(Package $package): void
    {
        ...
        $package->name(static::$name)
            ->hasInstallCommand(function (InstallCommand $command) {
                $command
                    ->publishConfigFile()
                    ->askToStarRepoOnGitHub('Caingougou/filament-records-finder');
            });
